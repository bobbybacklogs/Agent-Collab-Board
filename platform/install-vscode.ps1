<#
.SYNOPSIS
    Installs the Board Agent Toolkit skills for VS Code Copilot (global).

.DESCRIPTION
    Copies the skills/ bundle from this repository into $HOME\.agents\skills.
...
.EXAMPLE
    ...
    powershell -ExecutionPolicy Bypass -File platform/install-vscode.ps1 -Target "$HOME\.agents\skills"
#>
[CmdletBinding()]
param(
...
Write-Host "Board Agent Toolkit skills installed for VS Code Copilot at $Target"

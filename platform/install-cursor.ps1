<#
.SYNOPSIS
    Installs the Board Agent Toolkit skills for Cursor (global).

.DESCRIPTION
    Copies the skills/ bundle from this repository into $HOME\.cursor\skills.
...
.EXAMPLE
    ...
    powershell -ExecutionPolicy Bypass -File platform/install-cursor.ps1 -Target "$HOME\.cursor\skills"
#>
[CmdletBinding()]
param(
    [string]$Target = "$HOME\.cursor\skills"
)
...
Write-Host "Board Agent Toolkit skills installed for Cursor at $Target"
